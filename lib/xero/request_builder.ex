...
defmodule Xero.RequestBuilder do
  @moduledoc """
  ...
  def add_param(request, :headers, key, value) when is_atom(key),
    do: Tesla.put_header(request, Atom.to_string(key), value)

  def add_param(request, :headers, key, value) when is_binary(key),
    do: Tesla.put_header(request, key, value)
